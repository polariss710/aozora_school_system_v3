...
The Income and Expense pages read backend API lists, can create or void manual records, and can submit Cash requests; the Account Ledger page is still a read-only finance view while account write actions are connected incrementally.
