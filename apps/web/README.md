...
The Income and Expense pages read backend API lists and can create manual records; the Account Ledger page is still a read-only finance view while account write actions are connected incrementally.
