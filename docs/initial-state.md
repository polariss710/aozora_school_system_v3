...
- 后端 Controller 路由数约 `141`，已覆盖认证、用户、权限、主数据、学生课时、学生月度结算、学费账单、老师工资、勤务表导入、收入、支出、Cash 请求、Cash 入站、账户流水、报销、外部授课、审计、健康检查和版本信息。
...
- 第一轮主业务 API：
  ...
  - 学生预定课时 / 实际课时，包括批量生成、取消、恢复、补课、跨月补课和学生结算锁定保护。
