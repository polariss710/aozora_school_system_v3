...
- 后端 Controller 路由数为 `153`，已覆盖认证、用户、权限、主数据、学生课时、学生月度结算、学费账单、学费收据快照、老师工资、勤务表导入、收入、支出、Cash 请求、Cash 入站、账户流水、报销、外部授课、审计、健康检查和版本信息。
...
- 未建立正式迁移脚本和迁移校验报告。
- 已确认 V3 prod 以 `2026-07` 为正式运营起点，只承接青空进学塾正式运营数据；迁移边界记录在 `docs/v3-prod-migration-boundary.md`。
